...
public class ThumbUpView extends LinearLayout implements View.OnClickListener {
    ...
    public ThumbUpView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDrawablePadding = typedArray.getDimension(R.styleable.ThumbUpView_tuv_drawable_padding, UIUtils.dip2px(context, DEFAULT_DRAWABLE_PADDING));
        ...
        mTextSize = typedArray.getDimension(R.styleable.ThumbUpView_tuv_drawable_padding, UIUtils.sp2px(context, CountView.DEFAULT_TEXT_SIZE));
