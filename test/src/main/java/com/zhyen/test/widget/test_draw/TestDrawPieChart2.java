...
public class TestDrawPieChart2 extends View {
    ...
    public TestDrawPieChart2(Context context) {
        super(context);
        init();
    }

    public TestDrawPieChart2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TestDrawPieChart2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//            第五个饼会离开一段距离
            if (i == 5) {
                canvas.drawArc(rectfMove, startAngle + 3, sweepAngle - 3, true, paintPie);
            } else {
                canvas.drawArc(rectfCommon, startAngle + 3, sweepAngle - 3, true, paintPie);
            }
...
//画斜线
            ...
            canvas.drawPoint(lineX, lineY, paint);
